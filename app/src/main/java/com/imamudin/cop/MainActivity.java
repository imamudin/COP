...
public class MainActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener, FragmentGallery.OnFragmentInteractionListener,
        FragmentImport.OnFragmentInteractionListener{
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_backup) {
            ...
            Toast.makeText(MainActivity.this, "monitoring",Toast.LENGTH_LONG).show();
            ...
            if(isConnected) {
                ...
                Toast.makeText(MainActivity.this, "Aplikasi membutuhkan koneksi internet.", Toast.LENGTH_LONG).show();
            }
            return true;
...
//        }
    ...
    private class WebServerRegistrationTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            try {
                ...
                pe.printStackTrace();
                Log.w("cop.imamudin", "po"+ pe.getMessage());
                //handler.sendEmptyMessage(MSG_REGISTER_WEB_SERVER_FAILURE);
            } catch (IOException io) {
                io.printStackTrace();
                Log.w("cop.imamudin", "io" + io.getMessage());
                //handler.sendEmptyMessage(MSG_REGISTER_WEB_SERVER_SUCCESS);
            } finally {
                if (conn != null) {
                    conn.disconnect();
    ...
    public void logout(){
        ...
        Intent myIntentA1A2 = new Intent(MainActivity.this, Login.class);

        MainActivity.this.startActivity(myIntentA1A2);
